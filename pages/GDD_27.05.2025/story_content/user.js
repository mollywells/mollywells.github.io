...
// Configure it: GET-request for the URL /data
xhr.open('GET', 'https://bmcresearch.utm.utoronto.ca/molly/index.php?slide_name=simulation&layer_name=navigationmap', true);
...
const videoIndex = 2; // alter this value until you find the one you want
let video = document.getElementsByTagName('video')[videoIndex];

// Toggle vis function
let p = GetPlayer();
let isHidden = p.GetVar("isHiddenMolly"); 
